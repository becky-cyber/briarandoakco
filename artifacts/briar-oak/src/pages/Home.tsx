    ...
    <div id="top" className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main className="relative pt-40 pb-32 px-6 lg:pt-48 lg:pb-40 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="italic font-light text-primary/90">thoughtfully planned</span>
          </motion.h1>
      ...
      <section className="py-24 md:py-32 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-accent rounded-full"></span> Details Done Quietly</div>
            <div className="hidden md:block w-px h-4 bg-border"></div>
            <div className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-accent rounded-full"></span> Your Style, Not Mine</div>
            <div className="hidden md:block w-px h-4 bg-border"></div>
            <div className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-accent rounded-full"></span> Real Over Perfect</div>
          </motion.div>
        </div>
      </section>

      {/* Contact Section */}
      <section id="contact" className="bg-primary text-primary-foreground py-24 md:py-32 px-6">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div
            ...
            variants={staggerContainer}
          >
            <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl lg:text-6xl font-serif font-semibold mb-6 leading-tight">
            ...
            <div className="space-y-8">
              {[
                ...
                <motion.div key={idx} variants={fadeUp} className="flex items-center gap-5 group">
                  ...
                  <p className="text-base tracking-wide font-light">{item.text}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
      ...
      <footer className="bg-background border-t border-border pt-20 pb-10 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <a href="#top" onClick={scrollTo("top")} className="inline-block text-primary font-serif text-3xl font-semibold mb-4 tracking-wider hover:text-accent transition-colors duration-300">
            BRIAR & OAK CO.
          </a>
          ...
          <div className="flex justify-center gap-8 mb-12">
            <a href="#" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300">
            ...
            <a href="#" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z"/></svg>
            </a>
          </div>
